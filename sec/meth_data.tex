...
In comparison to popular NLP benchmark data sets, numbers of training examples
for all three groups are rather small.
Learning representation from text data typically requires large data sets, often
in the magnitude of a million data points~\cite{Go2009}.

\outline{Set data set in relation to recent NLP papers}
